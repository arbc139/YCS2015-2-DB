...
submitter = User.create(
  str_id: 'submitter', password: 's', u_name: 'dy', sex: 'M', address: 'Seoul', birth: Date.parse('1997/09/20'), phone_number: '010', value_score: 0,
  role: 'submitter'
  )

submitter2 = User.create(
  str_id: 'submitter2', password: 's', u_name: 'dyd', sex: 'M', address: 'Seoul', birth: Date.parse('1922/09/20'), phone_number: '010', value_score: 0,
  role: 'submitter'
  )

submitter3 = User.create(
  str_id: 'submitter3', password: 's', u_name: 'dyd', sex: 'M', address: 'Seoul', birth: Date.parse('2001/01/01'), phone_number: '010', value_score: 0,
  role: 'submitter'
  )
